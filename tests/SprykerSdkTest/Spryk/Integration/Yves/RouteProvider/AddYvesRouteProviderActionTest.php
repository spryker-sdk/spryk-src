...
class AddYvesRouteProviderActionTest extends Unit
{
    ...
    public function testAddsYvesRouteProviderAction(): void
    {
        ...
        $this->tester->assertClassOrInterfaceHasMethod(ClassName::YVES_ROUTE_PROVIDER, 'addFooBarIndexRoute');
    }
    ...
    public function testAddsYvesRouteProviderActionOnProjectLayer(): void
    {
        ...
        $this->tester->assertClassOrInterfaceHasMethod(ClassName::PROJECT_YVES_ROUTE_PROVIDER, 'addFooBarIndexRoute');
    }
}
