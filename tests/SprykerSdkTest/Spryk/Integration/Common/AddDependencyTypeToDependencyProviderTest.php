...
class AddDependencyTypeToDependencyProviderTest extends Unit
{
    ...
    public function testAddsFacadeDependencyToZedBusinessFactoryWithoutBridgeOnProjectLevel(): void
    {
        ...
        $this->tester->assertClassOrInterfaceHasMethod(ClassName::PROJECT_ZED_BUSINESS_FACTORY, 'getZipZapFacade');
        ...
        $this->tester->assertClassOrInterfaceHasMethod(ClassName::PROJECT_ZED_DEPENDENCY_PROVIDER, 'provideBusinessLayerDependencies');
    ...
    public function testAddsFacadeDependencyToZedBusinessFactoryWithBridgeOnCoreLevel(): void
    {
        ...
        $this->tester->assertClassOrInterfaceHasMethod(ClassName::ZED_FACADE_BRIDGE, '__construct');
