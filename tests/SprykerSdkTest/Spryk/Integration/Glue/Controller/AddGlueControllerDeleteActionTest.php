...
class AddGlueControllerDeleteActionTest extends Unit
{
    ...
    public function testAddsGlueControllerAction(): void
    {
        ...
        $this->tester->assertClassOrInterfaceHasMethod(ClassName::GLUE_CONTROLLER, 'deleteAction');
    ...
    public function testAddsGlueControllerOnProjectLayer(): void
    {
        ...
        $this->tester->assertClassOrInterfaceHasMethod(ClassName::PROJECT_GLUE_CONTROLLER, 'deleteAction');
