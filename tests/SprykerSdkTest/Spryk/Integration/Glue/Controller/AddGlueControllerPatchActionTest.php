...
class AddGlueControllerPatchActionTest extends Unit
{
    ...
    public function testAddsGlueControllerAction(): void
    {
        ...
        $this->tester->assertClassOrInterfaceHasMethod(ClassName::GLUE_CONTROLLER, 'patchAction');
    ...
    public function testAddsGlueControllerOnProjectLayer(): void
    {
        ...
        $this->tester->assertClassOrInterfaceHasMethod(ClassName::PROJECT_GLUE_CONTROLLER, 'patchAction');
