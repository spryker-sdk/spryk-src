...
class AddGlueControllerPostActionTest extends Unit
{
    ...
    public function testAddsGlueControllerAction(): void
    {
        ...
        $this->assertFileExists($this->tester->getSprykerModuleDirectory() . 'src/Spryker/Glue/FooBar/FooBar/FooBarWriter.php');
    }
    ...
    public function testAddsGlueControllerOnProjectLayer(): void
    {
        ...
        $this->assertFileExists($this->tester->getProjectModuleDirectory('FooBar', 'Glue') . 'FooBar/FooBarWriter.php');
    }
}
