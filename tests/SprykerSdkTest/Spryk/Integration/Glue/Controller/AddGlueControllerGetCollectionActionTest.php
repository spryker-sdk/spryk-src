 ...
 */
class AddGlueControllerGetCollectionActionTest extends Unit
{
    /**
    ...
    public function testAddsGlueControllerAction(): void
    {
        $this->tester->run($this, [
            ...
            '--controllerMethod' => 'getCollectionAction',
        ]);

        $this->assertFileExists($this->tester->getSprykerModuleDirectory() . 'src/Spryker/Glue/FooBar/Controller/BarController.php');
        $this->tester->assertClassOrInterfaceHasMethod(ClassName::GLUE_CONTROLLER, 'getCollectionAction');
    ...
    public function testAddsGlueControllerOnProjectLayer(): void
    {
        ...
        $this->tester->assertClassOrInterfaceHasMethod(ClassName::PROJECT_GLUE_CONTROLLER, 'getCollectionAction');
