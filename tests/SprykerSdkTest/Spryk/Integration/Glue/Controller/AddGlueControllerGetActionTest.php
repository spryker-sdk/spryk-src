...
class AddGlueControllerGetActionTest extends Unit
{
    ...
    public function testAddsGlueControllerAction(): void
    {
        ...
        $this->tester->assertClassOrInterfaceHasMethod(ClassName::GLUE_CONTROLLER, 'getAction');
    ...
    public function testAddsGlueControllerOnProjectLayer(): void
    {
        ...
        $this->tester->assertClassOrInterfaceHasMethod(ClassName::PROJECT_GLUE_CONTROLLER, 'getAction');
